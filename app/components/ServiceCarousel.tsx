...
const ServiceCarousel: React.FC<ServiceCarouselProps> = ({ onServiceSelect }) => {
    ...
    const handleServiceClick = (service: string, index: number) => {
        ...
        onServiceSelect(service); // Pass selected service to the parent
    };
            ...
            <div className="relative overflow-hidden">
                ...
                >
                    {resources.map((resource, index) => (
                        <ServiceCarouselButton key={index} service={resource.service} onClick={() => handleServiceClick(resource.service, index)}
