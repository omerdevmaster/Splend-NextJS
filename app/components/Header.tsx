...
const Header: React.FC = () => {
    ...
    return (
        <Box className="flex items-center justify-between top-mobile-mode-menu w-full h-full sm:px-[4vw] md:px-[4vw] lg:px-[4vw]" >
            ...
            {isMobile ? <Box className={`flex w-full justify-between ${isMenuOpen ? 'block' : 'hidden'} lg:flex`}>
                <Box className="flex items-center justify-between mobile-mode-menu w-full">
